...
few_shot_examples = [
    {
        "text": "Patiënt klaagt over pijn in de linkerhand.",
        "affected_hand": "linkerhand"
    },
    {
        "text": "Er is sprake van zwelling in de rechterhand.",
        "affected_hand": "rechterhand"
    },
    {
        "text": "De klachten zijn bilateraal, zowel links als rechts.",
        "affected_hand": "beide handen"
    },
    {
        "text": "Patiënt meldt tintelingen in de duim van de linkerhand.",
        "affected_hand": "linkerhand"
    },
    {
        "text": "Pijn en stijfheid in beide polsen gemeld.",
        "affected_hand": "beide handen"
    },
    {
        "text": "Geen duidelijke klachten in de handen.",
        "affected_hand": "none"
    },
    {
        "text": "Geen meldingen van pijn in de handen.",
        "affected_hand": "none"
    }
]
...
def evaluate_model(test_data, model_name, temperature):
    ...
    for test_sample in tqdm(test_data):
        label_name = test_sample.get("label_to_extract", "affected_hand")
        ...
        for example in few_shot_examples:
            context += f"Text:\n{example['text']}\nOutput:\n{{\"{label_name}\": \"{example['affected_hand']}\"}}\n\n"
...
def main():
    parser = argparse.ArgumentParser(description="Evaluate LLM affected hand extraction.")
