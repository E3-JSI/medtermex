...
few_shot_examples = [
    {
        "text": "Na de injectie trad er een abces op.",
        "complication": "abces"
    },
    {
        "text": "Ontsteking na corticosteroïdinjectie in de knie.",
        "complication": "ontsteking"
    },
    {
        "text": "Geen complicaties na injectie.",
        "complication": "none"
    },
    {
        "text": "Pijn en zwelling na injectie.",
        "complication": "pijn en zwelling"
    },
    {
        "text": "Geen bijwerkingen waargenomen.",
        "complication": "none"
    }
]
...
SYNONYM_MAP = {
    ...
    "pijn en zwelling": "pijn en zwelling",
    "geen complicaties": "none",
    "geen bijwerkingen": "none",
    "null": "none",
    "": "none"
}
...
def evaluate_model(test_data, model_name, temperature):
    ...
    for test_sample in tqdm(test_data):
        label_name = test_sample.get("label_to_extract", "complication")
        ...
        for example in few_shot_examples:
            context += f"Text:\n{example['text']}\nOutput:\n{{\"{label_name}\": \"{example['complication']}\"}}\n\n"
...
def main():
    parser = argparse.ArgumentParser(description="Evaluate LLM complication extraction.")
